                            ...
                            <form action="{{ route('produtos.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nome" class="form-control"
                                        placeholder="Adicione o titulo" value="{{ old('nome') }}">
                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="qtd" class="form-control"
                                                placeholder="Adicione a QTD de estoque" value="{{ old('qtd') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="valor_oferta" class="form-control"
                                                placeholder="Adicione o valor da oferta" value="{{ old('valor_oferta') }}">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="inicio_oferta" class="form-control"
                                                placeholder="Adicione a data" value="{{ old('inicio_oferta') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="fim_oferta" class="form-control"
                                                placeholder="Adicione a data" value="{{ old('inicio_oferta') }}">
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="video" class="form-control"
                                        placeholder="Adicione o vídeo" value="{{ old('video') }}">
                                </div>

                                <div class="form-group">
                                    <label for="">Código de Barras</label>
                                    <input type="text" name="codigo_barras" class="form-control"
                                        placeholder="Adicione o Código de Barras" value="{{ old('codigo_barras') }}">
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="google_titulo" class="form-control"
                                                placeholder="Adicione seo titulo" value="{{ old('google_titulo') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="google_descricao" class="form-control"
                                                placeholder="Adicione Seo Descrição"
                                                value="{{ old('google_descricao') }}">
                                        </div>
                                    </div>
