              ...
              <div class="col-12 ">
                ...
                @endif
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title_one" class="form-control" placeholder="Adicione o titulo 1" value="{{old('title_one')}}">
                        </div>
                        <div class="form-group">
                            <label for="titulo">Titulo 2</label>
                            <input type="text" name="title_two" class="form-control" placeholder="Adicione o titulo 2" value="{{old('title_two')}}">
                        </div>
                      <div class="form-group">
    <label for="valor">Valor</label>
    <input type="text" name="starting_price" class="form-control" placeholder="Adicione o preço" value="{{old('starting_price')}}">
</div>
