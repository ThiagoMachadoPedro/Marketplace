                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('vendedor-perfil.store') }}" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="fone" class="form-control"
                                        placeholder="Adicione o Whatsapp" value="{{ old('fone', $perfil->fone) }}">
                                </div>

                                <div class="form-group">
                                    <label for="">E-mail</label>
                                    <input type="email" name="email" class="form-control"
                                        placeholder="Adicione o e-mail" value="{{ old('email', $perfil->email) }}">
                                </div>

                                <div class="form-group">
                                    <label for="">Endereço</label>
                                    <input type="text" name="endereco" class="form-control"
                                        placeholder="Adicione o endereço com número"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="url" name="yt_link" class="form-control"
                                        placeholder="Adicione url da rede social"
                                        value="{{ old('yt_link', $perfil->yt_link) }}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="url" name="insta_link" class="form-control"
                                        placeholder="Adicione url da rede social"
                                        value="{{ old('insta_link', $perfil->insta_link) }}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="url" name="fb_link" class="form-control"
                                        placeholder="Adicione url da rede social"
                                        value="{{ old('fb_link', $perfil->fb_link) }}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="url" name="x_link" class="form-control"
                                        placeholder="Adicione url da rede social"
                                        value="{{ old('x_link', $perfil->x_link) }}">
                                </div>
