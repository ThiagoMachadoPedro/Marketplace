...
<head>
  ...
  <title>Painel Admisnistrativo  &mdash;</title>
    ...
    <div class="main-wrapper main-wrapper-1">
      ...
      <footer class="main-footer">
        <div class="footer-left">
          Todos os Direitos Reservados &copy; <?= date('Y') ?> <div class="bullet"></div> Desenvolvido <a href="https://curriculo-iedc2xugj-thiagomachadopedros-projects.vercel.app" target="_blank" >Thiago Machado</a> Versão 1.0
        </div>
